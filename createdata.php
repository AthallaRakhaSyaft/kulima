...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Validasi input
    if (empty($_POST['vkode']) || empty($_POST['vmatakuliah']) || empty($_POST['vsks'])) {
        ...
        $vsks = htmlspecialchars($_POST['vsks']);
        ...
        $query = "INSERT INTO matakuliah (kode, matakuliah, sks) VALUES (?, ?, ?)";
        ...
        mysqli_stmt_bind_param($stmt, "sss", $vkode, $vmatakuliah, $vsks);
...
<body>
    <div class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            ...
            <div class="form-group">
                <label for="vsks">SKS:</label>
                <input type="text" name="vsks" id="vsks" class="input-field" required>
            </div>
