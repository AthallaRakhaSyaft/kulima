...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Validasi input
    if (empty($_POST['vnim']) || empty($_POST['vnama']) || empty($_POST['vkode']) || empty($_POST['vmatakuliah'])) {
        $error = "Semua kolom harus diisi.";
    } else {
        // Ambil nilai dari form dan lakukan sanitasi input
        $vnim = htmlspecialchars($_POST['vnim']);
        $vnama = htmlspecialchars($_POST['vnama']);
        $vkode = htmlspecialchars($_POST['vkode']);
        ...
        $query = "INSERT INTO presensi (nim, nama, kode, matakuliah) VALUES (?, ?, ?, ?)";
        ...
        mysqli_stmt_bind_param($stmt, "ssss", $vnim, $vnama, $vkode, $vmatakuliah);
    ...
    <div class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            <div class="form-group">
                <label for="vnim">Nim:</label>
                <input type="text" name="vnim" id="vnim" class="input-field" required>
            </div>
            <div class="form-group">
                <label for="vnama">Nama:</label>
                <input type="text" name="vnama" id="vnama" class="input-field" required>
            </div>
            <div class="form-group">
                <label for="vkode">Kode:</label>
                <input type="text" name="vkode" id="vkode" class="input-field" required>
            </div>
            <div class="form-group">
